...
public class ImageKillBox extends HiddenKillBox implements Drawable {
    ...
    public ImageKillBox(int x, int y, int directionX, int directionY, int width, int height, long positionDuration, Bitmap image) {
        this(x, y, directionX, directionY, width, height, positionDuration, new Animation(new Bitmap[]{image}, -1));
    }

    public ImageKillBox(int x, int y, int directionX, int directionY, int width, int height, long positionDuration, Animation animation) {
